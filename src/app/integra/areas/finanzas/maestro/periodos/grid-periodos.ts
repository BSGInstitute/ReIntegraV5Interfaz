...
export class GridPeriodos {
  columns: any = [
    ...
    {
      title: 'Fecha Inicial Finanzas',
      field: 'fechaInicialFinanzas',
      width: 200,
      editable: false,
      locked: false,
      sticky: false,
    ...
    {
      title: 'Fecha Fin Finanzas',
      field: 'fechaFinFinanzas',
      width: 200,
      editable: false,
      locked: false,
      sticky: false,
    ...
    {
      title: 'Fecha Inicio Ingresos',
      field: 'fechaInicialRepIngresos',
      width: 200,
      editable: false,
      locked: false,
      sticky: false,
    ...
    {
      title: 'Fecha Fin Ingresos',
      field: 'fechaFinRepIngresos',
      width: 200,
      editable: false,
      locked: false,
      sticky: false,

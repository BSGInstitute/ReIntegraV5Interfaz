export interface IReporteCambioFase {
  ...
  reporteOtroMedio: Array<IControlCambioFase>;
  reporteCambiosDeFaseOportunidad: Array<IReporteCambioFaseOportunidad>;
  reporteCambiosDeFaseOportunidadPredictivo: Array<IReporteCambioFaseOportunidad>;
...
export interface IReporteConteoDatosFase {
  conteoDatosFase: Array<{
    fase: string;
    inicio: number;
    momento: number;
...
export interface IReporteTasaCambioPredictivo {
  idAsesor: number;
  idCodigoPais: number;
  oportunidadesOCAnyIS: number;
  oportunidadesOCTotal: number;
...
export class ReporteTasaCambioPredictivo
  implements IReporteTasaCambioPredictivo
{
  idAsesor: number = 0;
  idCodigoPais: number = 0;
  oportunidadesOCAnyIS: number = 0;
...
export interface IControlCambioFase {
  ...
  programadasAutomaticasSinLlamada: number;
  programadasManualesSinLlamada: number;
  totalTimbradoAutomatica?: number;
  tiempoUtil?: number;


  programadasEjecutadasOtroMedio: number;
  programadasAutomaticasOtroMedio: number;
  programadasManualesOtroMedio: number;
...
export class ControlCambioFase implements IControlCambioFase {
  ...
  programadasAutomaticasSinLlamada: number = 0;
  programadasManualesSinLlamada: number = 0;
  totalTimbradoAutomatica: number = 0;

  programadasEjecutadasOtroMedio: number = 0;
  programadasAutomaticasOtroMedio: number = 0;
  programadasManualesOtroMedio: number = 0;
}
...
export class CalidadProcesamientoAlterno
  implements ICalidadProcesamientoAlterno
{
  datosAsesor: string = '';
  nombreFase: string = '';
  registros?: number = 0;
...
export interface ItemConteoFasePais {
  ...
  inicioChile: number;
  momentoChile: number;
  inicioWhatsapp: number;
  momentoWhatsapp: number;
  inicioOtros: number;
  momentoOtros: number;
  inicioTotal: number;
  momentoTotal: number;
}
export interface ControlOportunidadPredictiva {
  fechaCreacion: Date;

 ...
 * @version 1.0
   History
 * 15/111/2022 RegistrarSolicitudInterna
 */
   @Component({
...
export class SolicitudInternaComponent implements OnInit {
  ...
  buscarAlumno(){
    ...
    registrarSolicitudInterna(){
      ...
      if (this.idSolicitud===null || this.idSolicitud===undefined){
        ...
        this.integraService
          .insertarFormData2(constApiOperaciones.InsertarSolicitudInterna, formData)
          .subscribe({

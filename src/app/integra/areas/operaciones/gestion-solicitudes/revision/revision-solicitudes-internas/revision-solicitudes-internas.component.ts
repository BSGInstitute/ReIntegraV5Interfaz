...
@Component({
  selector: 'app-revision-solicitudes-internas',
  templateUrl: './revision-solicitudes-internas.component.html',
  styleUrls: ['./revision-solicitudes-internas.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class RevisionSolicitudesInternasComponent implements OnInit {
  ...
  estadosRevision: any = [
    {
      id: 2,
      nombre: 'Observado Revisor',
    },
    {
      id: 3,
      nombre: 'Asignado a Responsable',
    },
  ];
  ...
  ngOnInit(): void {
    ...
    this.integraService
      .obtenerTodo(constApiOperaciones.ObtenerEstadosSolicitudRevision)
      .subscribe({
        next: (response: HttpResponse<any[]>) => {
    ...
    this.cargarDatosArea(this.idPersonal);
  }
  cargarDatosArea(idPersonal: any) {
    this.integraService
      .postJsonResponse(
        `${constApiOperaciones.obtenerSolicitudesInternaPorAreaPersonal}/${idPersonal}`,
        null
      )
      .subscribe({

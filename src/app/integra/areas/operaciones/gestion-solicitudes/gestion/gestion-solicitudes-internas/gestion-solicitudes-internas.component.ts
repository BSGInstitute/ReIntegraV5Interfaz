...
@Component({
  selector: 'app-gestion-solicitudes-internas',
  templateUrl: './gestion-solicitudes-internas.component.html',
  styleUrls: ['./gestion-solicitudes-internas.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class GestionSolicitudesInternasComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.integraService
      .obtenerTodo(constApiOperaciones.ObtenerEstadosSolicitudGestion)
      .subscribe({
        next: (response: HttpResponse<any[]>) => {
  ...
  cargarDatosArea(idPersonal: any) {
    this.integraService
      .postJsonResponse(
        `${constApiOperaciones.obtenerSolicitudesInternasGestion}/${idPersonal}`,
        null
      )
      .subscribe({

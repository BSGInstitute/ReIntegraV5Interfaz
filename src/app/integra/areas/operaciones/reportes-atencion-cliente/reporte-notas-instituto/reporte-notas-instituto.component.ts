...
@Component({
  selector: 'app-reporte-notas-instituto',
  templateUrl: './reporte-notas-instituto.component.html',
  styleUrls: ['./reporte-notas-instituto.component.scss']
})
export class ReporteNotasInstitutoComponent implements OnInit {
  ...
  dataNotas = [
    {
      ...
      ciclo: 'I',
      curso: 'ALGEBRA LINEAL ONLINE 2024 I AQP',
      fechaInicio: '2025-01-15T14:08:28.863',
      fechaTermino: '2025-05-15T14:08:28.863',
    ...
    this.integraService
      ...
      .subscribe({
        next: (resp: any) => {
          ...
          this.gridData.data = this.dataNotas;

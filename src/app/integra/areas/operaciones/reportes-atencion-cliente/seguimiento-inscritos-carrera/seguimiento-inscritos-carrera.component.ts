...
@Component({
  selector: 'app-seguimiento-inscritos-carrera',
  templateUrl: './seguimiento-inscritos-carrera.component.html',
  styleUrls: ['./seguimiento-inscritos-carrera.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class SeguimientoInscritosCarreraComponent implements OnInit {
  ...
  datosEgresados = [
    {
      ...
      fechaTermino: '2025-03-14T14:08:28.863',
      fechaInicioCurso: '2025-03-14T14:08:28.863',
      estadoMatricula: 'REGULAR',
      modalidad: 'ONLINE SINCRÓNICO',
      correo: 'OIJKNJ43@6JHBNJGU', //vicosaba27@hotmail.com
      fechaNacimiento: '1984-06-01T14:08:28.863',
      edad: '38',
      pais: 'Perú',
      industria: 'Sin Industria',
      lugarTrabajo: '--',
      cargo: '--',
    },
    {
      ...
      estadoMatricula: 'REGULAR',
      modalidad: 'ONLINE SINCRÓNICO',
      correo: 'FDHDSFGF@EDS32452', //ceyoshiokav@gmail.com
      fechaNacimiento: '1989-06-01T14:08:28.863',
      edad: '33',
      pais: 'Perú',
      industria: 'Arquitectura/Construccion/Inmobiliaria',
      lugarTrabajo: 'KAISHAIN EIRL',
      cargo: 'Jefe',
    },
  ];

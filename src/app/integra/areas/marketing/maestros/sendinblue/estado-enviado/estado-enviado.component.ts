...
@Component({
  selector: 'app-estado-enviado',
  templateUrl: './estado-enviado.component.html',
  styleUrls: ['./estado-enviado.component.scss']
})
export class EstadoEnviadoComponent implements OnInit {
  @ViewChild(MatPaginator) paginator!: MatPaginator;
  @ViewChild(MatSort) sort!: MatSort;
  
  displayedColumns: string[] = ['numero', 'nombre', 'fecha','fechaEnvio', 'tipo'];

...
var WhatsappFacebookGrillaComponent = /** @class */ (function () {
    ...
    WhatsappFacebookGrillaComponent.prototype.obtenerGrillass = function () {
        var _this = this;
        this.integraService
            .getJsonResponse("" + (constApi_1.constApiMarketing.ObtenerWhatsappFacebookMasivo + '/' + this.tab + '/' + this.diaDrop.Value))
            .subscribe({
    ...
    __decorate([
        core_1.Input()
    ], WhatsappFacebookGrillaComponent.prototype, "tab");
    __decorate([
        core_1.Input()
    ], WhatsappFacebookGrillaComponent.prototype, "dia");
    WhatsappFacebookGrillaComponent = __decorate([
        core_1.Component({

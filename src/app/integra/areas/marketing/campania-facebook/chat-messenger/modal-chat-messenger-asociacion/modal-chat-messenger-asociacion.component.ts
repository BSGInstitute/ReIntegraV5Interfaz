...
@Component({
  selector: 'app-modal-chat-messenger-asociacion',
  templateUrl: './modal-chat-messenger-asociacion.component.html',
  styleUrls: ['./modal-chat-messenger-asociacion.component.scss']
})
export class ModalChatMessengerAsociacionComponent implements OnInit {

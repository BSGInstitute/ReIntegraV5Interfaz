...
export var gridAsignacionDatos = new KendoGrid();
gridAsignacionDatos.columns = [
  {
    title: 'Nombre',
    field: 'nombre',
    width: 250,
...
gridAsignacionDatos.selectable =  true
gridAsignacionDatos.resizable = true;
gridAsignacionDatos.gridState = {
  skip: 0,
  take: 20,
};
...
export var gridAsignacionRegular = new KendoGrid();
gridAsignacionRegular.columns = [
  {
...
gridAsignacionRegular.selectable =  true
gridAsignacionRegular.resizable = true;
gridAsignacionRegular.gridState = {
  skip: 0,
  take: 20,
};

...
@Component({
  selector: 'app-agregar-prioridad-excel',
  templateUrl: './agregar-prioridad-excel.component.html',
  styleUrls: ['./agregar-prioridad-excel.component.scss']
})
export class AgregarPrioridadExcelComponent implements OnInit {
  ...
  crearPrioridad(){
    ...
    if(this.nombrePrioridadExcel != '' && this.numeroPrioridadExcel != ''){
      this.integraService
      .postJsonResponse(
        constApiMarketing.InsertarCampaniaGeneralDetalleExcelWhatsApp,
        jsonEnvio
      )
      .subscribe({

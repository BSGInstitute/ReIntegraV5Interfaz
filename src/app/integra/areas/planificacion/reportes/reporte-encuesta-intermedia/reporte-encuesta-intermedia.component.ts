 ...
 * @description Componente del Reporte Encuesta Intermedia
 * @author Jonathan Raúl Caipo Huacasi
 * @version 1.0.0
 * @history
   22/06/2023 Implementacion del Reporte Encuesta Intermedia
   22/06/2023 Creacion de Grilla
 */

@Component({
  selector: 'app-reporte-encuesta-intermedia',
  templateUrl: './reporte-encuesta-intermedia.component.html',
  styleUrls: ['./reporte-encuesta-intermedia.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ReporteEncuestaIntermediaComponent implements OnInit {
  ...
  gridReporteEncuestaIntermedia: KendoGrid = new KendoGrid();
  ...
  ngOnDestroy(): void {
    ...
    gridReporteEncuestaIntermedia: null;
    arrayColumnas: [];
    data: [];
  }
  ...
  generarReporte(){
    if (this.formFiltro.valid) {
      this.gridReporteEncuestaIntermedia.loading = true;
      ...
      this.integraService
        .postJsonResponse(
          constApiPlanificacion.ReporteEncuestasGenerarReporteEncuestaIntermedia,
          JSON.stringify(filtro)
        )
        .subscribe({
          next: (resp: HttpResponse<ReporteEncuesta[]>) => {
            this.gridReporteEncuestaIntermedia.data = resp.body;
            this.gridReporteEncuestaIntermedia.loading = false;
  ...
  crearDataParaExcel(){
    this.data = [];
    this.gridReporteEncuestaIntermedia.data.forEach((x: ReporteEncuesta) => {
      let obj: any = {}
      obj.alumno = x.alumno;
  ...
  abrirDetalle (event: any) {
    ...
    const idTipoEncuesta = 2; // Encuesta Inicial

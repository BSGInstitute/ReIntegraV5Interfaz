...
exports.RevisarAprobarMaterialComponent = void 0;
 ...
 * @version 1.0.0
 * @history
   26/08/2023 Implementacion del Módulo Revisar y Aprobar Material por Pograma Específico
   26/08/2023 Creacion de Grilla
 */
var RevisarAprobarMaterialComponent = /** @class */ (function () {
    function RevisarAprobarMaterialComponent(integraService, alertaService, formBuilder) {
    ...
    Object.defineProperty(RevisarAprobarMaterialComponent.prototype, "dataFormFiltro", {
        get: function () {
    ...
    RevisarAprobarMaterialComponent.prototype.ngOnInit = function () {
        this.gridRevisarAprobarMaterial.gridState.skip = 0;
        this.gridRevisarAprobarMaterial.gridState.take = 15;
        this.obtenerCombosModulo();
    };
    RevisarAprobarMaterialComponent.prototype.obtenerCombosModulo = function () {
        var _this = this;
        this.integraService
            ...
            next: function (resp) {
                ...
                _this.formFiltro.get('idsEstadosMateriales').setValue([2]);
    ...
    RevisarAprobarMaterialComponent.prototype.generarReporte = function () {
        var _this = this;
        ...
        this.integraService
            .postJsonResponse(constApi_1.constApiPlanificacion.MaterialPespecificoObtenerMaterialesPorProgramaEspecificoGrupoRevisar, JSON.stringify(filtro))
            .subscribe({
            next: function (resp) {
    ...
    RevisarAprobarMaterialComponent.prototype.aprobarMaterial = function (dataItem) {
        var _this = this;
        this.gridRevisarAprobarMaterial.loading = true;
        this.integraService
            .putJsonResponse(constApi_1.constApiPlanificacion.MaterialPespecificoAprobarMaterialVersion + "/" + dataItem.idMaterialPEspecificoDetalle, null)
            .subscribe({
            next: function (response) {
                console.log(response.body);
                sweetalert2_1["default"].fire('¡Aprobado!', 'Material Aprobado Correctamente.', 'success');
                _this.gridRevisarAprobarMaterial.loading = false;
                _this.generarReporte();
                _this.alertaService.notificationSuccessBotom("Material Aprobado Correctamente.");
            },
            error: function (error) {
                _this.gridRevisarAprobarMaterial.loading = false;
                var mensaje = _this.alertaService.getMessageErrorService(error);
    ...
    RevisarAprobarMaterialComponent.prototype.desaprobarMaterial = function (dataItem) {
        var _this = this;
        console.log("dataItem", dataItem);
        this.gridRevisarAprobarMaterial.loading = true;
        this.integraService
            .getJsonResponse(constApi_1.constApiPlanificacion.MaterialPespecificoDesaprobarMaterialVersion + "/" + dataItem.idMaterialPEspecificoDetalle)
            .subscribe({
            next: function (response) {
                console.log(response.body);
                sweetalert2_1["default"].fire('¡Desaprobado!', 'Material Desaprobado Correctamente.', 'success');
                _this.gridRevisarAprobarMaterial.loading = false;
                _this.generarReporte();
                _this.alertaService.notificationSuccessBotom("Material Desaprobado Correctamente.");
            },
            error: function (error) {
                _this.gridRevisarAprobarMaterial.loading = false;
                var mensaje = _this.alertaService.getMessageErrorService(error);
    ...
    RevisarAprobarMaterialComponent.prototype.cargarSubAreas = function (idsArea) {
        var _this = this;
    ...
    RevisarAprobarMaterialComponent.prototype.cargarPGenerales = function (idsSubAreas) {
        var _this = this;
    ...
    RevisarAprobarMaterialComponent.prototype.cargarPEspecificos = function (idsPgeneral) {
        var _this = this;
    ...
    RevisarAprobarMaterialComponent.prototype.cargarPEspecificoCurso = function (idsPespecificos) {
        var _this = this;
    ...
    RevisarAprobarMaterialComponent = __decorate([
        core_1.Component({
            selector: 'app-revisar-aprobar-material',
            templateUrl: './revisar-aprobar-material.component.html',
            styleUrls: ['./revisar-aprobar-material.component.scss']
        })
    ], RevisarAprobarMaterialComponent);
    return RevisarAprobarMaterialComponent;
}());
exports.RevisarAprobarMaterialComponent = RevisarAprobarMaterialComponent;

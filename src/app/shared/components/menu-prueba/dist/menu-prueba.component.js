...
exports.MenuPruebaComponent = void 0;
...
var MenuPruebaComponent = /** @class */ (function () {
    function MenuPruebaComponent(router) {
        this.router = router;
        this.items = items.parents;
        this.flexBasis = 'flex-basis: 0px;';
        this.toggle = false;
    }
    MenuPruebaComponent.prototype.ngAfterViewInit = function () {
        this.drawer.toggle(this.toggle);
        this.flexBasis = 'flex-basis: 0px;';
    };
    MenuPruebaComponent.prototype.ngOnInit = function () {
    };
    MenuPruebaComponent.prototype.onSelect = function (ev) {
        var _this = this;
        this.selected = ev.item.text;
        if (ev.item.urlPath) {
            this.router.navigate([ev.item.urlPath]);
        }
        var item = this.items.find(function (e, index) {
    ...
    MenuPruebaComponent.prototype.addChildren = function (children) {
        var _a;
        (_a = this.items).splice.apply(_a, __spreadArrays([this.itemIndex + 1, 0], children));
    };
    MenuPruebaComponent.prototype.removeChildren = function (children) {
        this.items.splice(this.itemIndex + 1, children.length);
    };
    MenuPruebaComponent.prototype.drawerToggle = function () {
    ...
    ], MenuPruebaComponent.prototype, "drawer");
    MenuPruebaComponent = __decorate([
        core_1.Component({
    ...
    return MenuPruebaComponent;
}());
exports.MenuPruebaComponent = MenuPruebaComponent;

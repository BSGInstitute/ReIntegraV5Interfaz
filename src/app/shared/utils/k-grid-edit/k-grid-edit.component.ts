...
@Component({
  ...
  templateUrl: './k-grid-edit.component.html',
  styleUrls: ['./k-grid-edit.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class KGridEditComponent implements OnInit {
  /**
  ...
  @Input() textAddCommand: string = 'Agregar';
  ...
  cellClickHandler(args: CellClickEvent): void {
    ...
    if(args.column.field != null){
      if (!args.isEdited && !this.isReadOnly(args.column.field) && (this.commandEdit == 'cell-click' || this.commandEdit == 'cell-row')) {
